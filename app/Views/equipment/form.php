<?php
/**
 * app/Views/equipment/form.php
 * Biến truyền vào từ EquipmentController::form(): $id, $old, $errors, $types, $rooms
 */
...
<div class="chart-card" style="max-width:560px;">
    ...
    <form method="post" action="/mvc/equipment/save">
        <?php echo csrf_field(); ?>
        ...
        <a href="/mvc/equipment" class="btn btn-secondary">Huỷ</a>
    </form>
</div>
