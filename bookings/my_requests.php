...
<div class="page-heading">
    <div>
        ...
        <p>Theo dõi, xem chi tiết, chỉnh sửa hoặc hủy yêu cầu đang chờ duyệt.</p>
    </div>
    <a href="/bookings/form.php" class="btn btn-primary">Tạo yêu cầu</a>
</div>
...
<section class="content-card">
    <form method="get" class="booking-filter">
        ...
        <div class="filter-actions">
            ...
            <a href="/bookings/my_requests.php" class="btn btn-secondary">Đặt lại</a>
        </div>
    </form>
</section>
                        ...
                        <td>
                            <div class="row-actions">
                                ...
                                <?php if ($item['trang_thai'] === 'pending'): ?>
                                    <a href="/bookings/form.php?id=<?php echo (int) $item['id']; ?>" class="btn btn-secondary btn-small">Sửa</a>
