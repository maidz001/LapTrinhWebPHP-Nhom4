 ...
 * rooms/form.php
 * ---------------------------------------------------------------------
 * Form thêm mới / sửa phòng thực hành. Chỉ admin và lab_staff được truy cập.
 * Submit tới rooms/save.php. ?id=X để sửa, không có id để thêm mới.
 * ---------------------------------------------------------------------
 */
...
$old = $_SESSION['room_old'] ?? $room ?? [];
unset($_SESSION['room_old']);
...
<div class="chart-card" style="max-width:560px;">
    ...
    <form method="post" action="/rooms/save.php">
        <?php echo csrf_field(); ?>
        ...
        <a href="/rooms/list.php" class="btn btn-secondary">Huỷ</a>
    </form>
</div>
